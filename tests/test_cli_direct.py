...
class TestCLIDirect:
    ...
    def test_setup_signal_handlers(self, ensure_cli_module: None) -> None:
        """Test signal handler setup."""
        # Get CLI module
        cli = sys.modules["fastblocks.cli"]

        # Since our mock implementation doesn't actually call signal.signal,
    ...
    def test_create_command(self, ensure_cli_module: None) -> None:
        ...
        # For our test purposes, we'll just verify the function exists
        # The actual implementation is tested in test_cli_comprehensive.py
