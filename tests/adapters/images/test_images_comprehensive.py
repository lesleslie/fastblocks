...
from fastblocks.adapters.images.cloudinary import CloudinaryAdapter, CloudinarySettings
from fastblocks.adapters.images.imagekit import ImageKitAdapter, ImageKitSettings
...
class TestCloudinaryAdapter:
    ...
    def test_cloudinary_adapter_initialization(self):
        ...
        assert isinstance(adapter.settings, CloudinarySettings)
        assert adapter.MODULE_STATUS == "stable"
        assert isinstance(adapter.MODULE_ID, UUID)
    ...
    def test_cloudinary_img_tag_basic(self):
        ...
        assert 'src="https://res.cloudinary.com/test-cloud/image/upload/test.jpg"' in result
    ...
    def test_cloudinary_build_transformation_url(self):
        ...
        url = adapter._build_transformation_url("test.jpg", {
            "width": 300,
            "height": 200,
            "crop": "fill",
            "quality": "auto",
...
class TestImageKitAdapter:
    ...
    def test_imagekit_adapter_initialization(self):
        ...
        assert isinstance(adapter.settings, ImageKitSettings)
        assert adapter.MODULE_STATUS == "stable"
        assert isinstance(adapter.MODULE_ID, UUID)
...
class TestImageAdapterIntegration:
    ...
    def test_settings_validation(self):
        ...
        imagekit_settings = ImageKitSettings()
    ...
    async def test_protocol_compliance(self):
        ...
        adapters = [CloudinaryAdapter(), ImageKitAdapter()]
