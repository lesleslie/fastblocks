...
## status: active role: canonical date: 2026-08-23 last_reviewed: 2026-08-23 supersedes: docs/superpowers/specs/2026-08-23-fastblocks-phase-4-v2-design.md superseded_by: null decision_date: 2026-08-23 topic: phase-4-v21-design
...
1. **Consumer-pattern documentation** — `docs/superpowers/specs/...`
...
1. **Custom discovery schema (optional)** — `fastblocks/mcp/discovery.py`
...
1. **Test surface** — 21 new tests + 13 deleted tests (the entire
