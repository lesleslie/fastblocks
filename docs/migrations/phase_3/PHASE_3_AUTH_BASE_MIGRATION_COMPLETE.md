...
1. **Simple and explicit**: Clear constructor patterns
1. **Flexible**: Explicit parameter handling
...
1. **Simplified Properties**: Direct implementations instead of complex config resolution
