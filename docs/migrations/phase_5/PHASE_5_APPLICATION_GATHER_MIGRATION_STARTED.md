...
2. **Adapter Management**: Integration with ACB adapter system
3. **Dependency Resolution**: Complex dependency gathering logic
4. **Initialization**: Application component initialization system
5. **Configuration**: Application configuration management
...
2. `middleware.py` - Middleware gathering
3. `models.py` - Model gathering
4. `strategies.py` - Gathering strategies
5. `templates.py` - Template gathering
6. Sync actions files (6 files)
